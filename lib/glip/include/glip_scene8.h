...
#ifndef _GLIP_SCENE8_H_
#define _GLIP_SCENE8_H_
...
namespace glip{
  namespace Scene8{
    ...
    uchar   GetMaximumValue(sScene8 *scn); /*deprecated function*/
    uchar   GetMinimumValue(sScene8 *scn); /*deprecated function*/
