...
#ifndef _GLIP_SCENE_H_
#define _GLIP_SCENE_H_
...
typedef enum {integer, reals} glip_SceneType;
...
namespace glip{
   ...
   * \brief A constructor.
   */
  sScene *Create(int xsize,int ysize,int zsize, int nbits, glip_SceneType type);
  /**
