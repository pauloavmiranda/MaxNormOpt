...
namespace glip{
  namespace Color{
    ...
    int RGB2YCbCr(int v) {
      ...
      y=0.299*(float)Channel0(v)+
	0.587*(float)Channel1(v)+
	0.114*(float)Channel2(v);
      
      cb=-0.169*(float)Channel0(v)- 
	  0.331*(float)Channel1(v)+ 
 	  0.500*(float)Channel2(v)+128;
      
      cr=0.500*(float)Channel0(v)-
	 0.419*(float)Channel1(v)-
	 0.081*(float)Channel2(v)+128;
    ...
    int YCbCr2RGB(int v) {
      ...
      r=1.000*(float)Channel0(v)-
	0.001*((float)Channel1(v)-128)+
	1.402*((float)Channel2(v)-128);
      
      g=1.000*(float)Channel0(v)-
	0.344*((float)Channel1(v)-128)-
	0.714*((float)Channel2(v)-128);
      
      b=1.000*(float)Channel0(v)+
	1.772*((float)Channel1(v)-128)+
	0.001*((float)Channel2(v)-128);
