  ...
  namespace CImage32f{
	...
	*cimg = NULL;
    ...
    sCImage32f *Clone(sCImage32f *cimg){
      ...
      if (imgc == NULL){
	glip::Error((char *)MSG1,(char *)"CImage32f::Clone");
      }
      for (i=0; i<3; i++)
    ...
    sCImage32f *AddFrame(sCImage32f *cimg, int sz, float r, float g, float b){
      ...
      if (fcimg == NULL)
	glip::Error((char *)MSG1,(char *)"CImage32f::AddFrame");
      fcimg->C[0] = glip::Image32f::AddFrame(cimg->C[0], sz, r);
      fcimg->C[1] = glip::Image32f::AddFrame(cimg->C[1], sz, g);
      fcimg->C[2] = glip::Image32f::AddFrame(cimg->C[2], sz, b);
      return fcimg;
    }
    ...
    sCImage32f *RemFrame(sCImage32f *cimg, int sz){
      ...
      if (fcimg == NULL)
	glip::Error((char *)MSG1,(char *)"CImage32f::AddFrame");
      fcimg->C[0] = glip::Image32f::RemFrame(cimg->C[0], sz);
      fcimg->C[1] = glip::Image32f::RemFrame(cimg->C[1], sz);
      fcimg->C[2] = glip::Image32f::RemFrame(cimg->C[2], sz);
      return fcimg;
    }
