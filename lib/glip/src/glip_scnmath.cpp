...
namespace glip{
  ...
  namespace Scene{
	...
	glip::Error((char *)"Incompatible number of bits",
      ...
      if(diff == NULL) 
	glip::Error((char *)MSG1,(char *)"Scene::Sub");
	...
	glip::Error((char *)"Incompatible number of bits",
      ...
      if(sum == NULL) 
	glip::Error((char *)MSG1,(char *)"Scene::Add");
	...
	glip::Error((char *)"Incompatible number of bits",
      ...
      if(mscn == NULL) 
	glip::Error((char *)MSG1,(char *)"Scene::Mult");
	...
	glip::Error((char *)"Incompatible number of bits",
      ...
      if(scnor == NULL) 
	glip::Error((char *)MSG1,(char *)"Scene::Or");
	...
	glip::Error((char *)"Incompatible number of bits",
      ...
      if(scnand == NULL) 
	glip::Error((char *)MSG1,(char *)"Scene::And");
	...
	glip::Error((char *)"Incompatible number of bits",
      ...
      if(scnxor == NULL) 
	glip::Error((char *)MSG1,(char *)"Scene::XOr");
    ...
    sScene *Complement(sScene *scn){
      ...
      if(cscn == NULL) 
	glip::Error((char *)MSG1,(char *)"Scene::Complement");
