...
namespace glip{
  namespace PQueue16{
    ...
    sPQueue16 *Create(int nbuckets, int nelems, ushort *value){
      ...
      Q = (sPQueue16 *) malloc(1*sizeof(sPQueue16));
	...
	*Q = NULL;
    ...
    /// \cond
    inline int _FindMinBucket(sPQueue16 *Q){
      int current,last;
    ...
    /// \cond
    inline int _FindMaxBucket(sPQueue16 *Q){
      int current,last;
    ...
    /// \cond
    inline int _BucketFIFO(sPQueue16 *Q, int bucket){
      int elem=NIL, next;
    ...
    /// \cond
    inline int _BucketLIFO(sPQueue16 *Q, int bucket){
      int elem=NIL, prev;
    ...
    /// \cond
    inline int _FastFindMinBucket(sPQueue16 *Q){
      int current;
    ...
    /// \cond
    inline int _FastFindMaxBucket(sPQueue16 *Q){
      int current;
