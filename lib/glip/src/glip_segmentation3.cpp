...
*/
  ...
  int Otsu(glip::sScene32 *scn){
    glip::sCurve *hist=glip::Scene32::NormHistogram(scn);
    double p1,p2,m1,m2,s1,s2,J,Jmax=-1.0;
    int i,T,Topt=0,Imax=glip::Scene32::GetMaximumValue(scn);
