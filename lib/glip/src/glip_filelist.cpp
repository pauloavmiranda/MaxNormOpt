...
namespace glip{
  namespace FileList{
    ...
    sFileList *Create(int cap){
      ...
      L = (sFileList *) calloc(1,sizeof(sFileList));
      if(L == NULL)
	glip::Error((char *)MSG1,(char *)"FileList::Create");
	...
	*L = NULL;
	...
	glip::Error((char *)msg,(char *)"FileList::Read");
      }
    ...
    void      Write(sFileList *L,
      ...
      if(fp == NULL){
	sprintf(msg,"Cannot open %s",filename);
	glip::Error((char *)msg,(char *)"FileList::Write");
      }
